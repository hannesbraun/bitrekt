...
#define AUV2_FACTORY BitReKt_Factory
#define AUV2_VIEW_CLASS BitReKt_View
#define AUV2_VIEW_CLASS_STR "BitReKt_View"

#define AAX_TYPE_IDS 'IEF1', 'IEF2'
#define AAX_TYPE_IDS_AUDIOSUITE 'IEA1', 'IEA2'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "BitReKt\nIPEF"
