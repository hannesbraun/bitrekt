...
def main():
  ...
  plistpath = scriptpath + "/resources/BitReKt-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitReKt-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitReKt-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitReKt-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitReKt-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BitReKt.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BitReKt.iss",inplace=1):
