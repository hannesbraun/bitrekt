...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=BitReKt Demo Installer\n"
      else:
        line="OutputBaseFilename=BitReKt Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the BitReKt Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the BitReKt installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=BitReKt Demo installer\n"
     else:
       line="SetupWindowTitle=BitReKt installer\n"
